...
const Searchbar: React.FC<SearchbarProp> = ({
    ...
    return (
        <div className='mb-2 h-40px flex items-center justify-end gap-[2px] text-15px sm:text-16px'>
            <div className={`rounded-50px transition-opacity duration-300 overflow-hidden bg-white shadow-image ${showSearchbar ? '' : 'sm:opacity-0 sm:pointer-events-none'}`}>
            ...
            <div onClick={toggleShowSearchbar} className='hidden sm:flex relative h-40px w-40px items-center justify-center bg-white rounded-full shadow-image transition-bg duration-300 cursor-pointer hover:bg-lightgrey'>
